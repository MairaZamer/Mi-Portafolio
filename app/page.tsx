      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-gradient-to-b ">
        <div className="flex flex-col md:flex-row items-center text-center md:text-left container mx-auto p-4 flex-grow bg-opacity-50 rounded-lg shadow-lg justify-between bg-black bg-opacity-50">
          <div className="md:mr-10 mb-8 md:mb-0">
            <h1 className="text-6xl font-bold text-white dark:text-white mb-4" style={{ fontFamily: "'La Belle Aurore'" }}>
              Hola,
              <br />
              <br />
              <span className="text-5xl text-center text-amber-500 block mt-2 zoom-in-effect" style={{ fontFamily: "'La Belle Aurore'" }}>
                Soy Maira Zamer
              </span>
            </h1>
            <br />
            <p className="text-4xl text-white dark:text-gray-300 mb-8 zoom-in-effect" style={{ fontFamily: "'La Belle Aurore'" }}>
            ...
            <div className="mt-4 zoom-in-effect">
              <a
                ...
                style={{ fontFamily: "'La Belle Aurore'", fontSize: '1.5rem' }}
              >
                Descargar CV
              </a>
            </div>
